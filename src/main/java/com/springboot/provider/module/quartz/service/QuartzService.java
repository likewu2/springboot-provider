package com.springboot.provider.module.quartz.service;
...
public class QuartzService {
     ...
     * @param jobData      参数
     */
    public Boolean addJob(Class<? extends QuartzJobBean> jobClass, String jobName, String jobGroupName, Integer jobTime,
                       Integer jobTimes, Map jobData) {
        try {
            // 任务名称和组构成任务key
