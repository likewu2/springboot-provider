...
public class LogConfigurationSelector implements ImportSelector {
    private static final String LOG_INFO_CONFIG = "com.springboot.provider.selector.LogInfoConfig";
    private static final String LOG_ERROR_CONFIG = "com.springboot.provider.selector.LogErrorConfig";
