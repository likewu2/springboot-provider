...
public class SpringApplicationRunListenerHandler implements SpringApplicationRunListener {
    ...
    public void starting(ConfigurableBootstrapContext bootstrapContext) {
        System.out.println("[SpringApplicationRunListenerHandler] starting");
    }
    ...
    public void environmentPrepared(ConfigurableBootstrapContext bootstrapContext, ConfigurableEnvironment environment) {
        System.out.println("[SpringApplicationRunListenerHandler] environmentPrepared");
    }
    ...
    public void contextPrepared(ConfigurableApplicationContext context) {
        System.out.println("[SpringApplicationRunListenerHandler] contextPrepared");
    }
    ...
    public void failed(ConfigurableApplicationContext context, Throwable exception) {
        System.out.println("[SpringApplicationRunListenerHandler] failed");
    }
}
